    ...
    <AdminShell title="Cupons e Promoções">
      <div className="mx-auto max-w-[1400px] px-4 py-6 sm:px-8">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
          {COUPONS.map((c) => (
            <div key={c.code} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center gap-2">
                    <code className="rounded-md bg-slate-100 px-2 py-0.5 font-mono text-sm font-bold text-slate-900">
                      {c.code}
                    </code>
                    <button
                      onClick={() => {
                  ...
                  <div className="text-xs text-slate-500">
                    de desconto · expira em {c.expires}
                  </div>
                </div>
              ...
              <div className="mt-4 flex gap-2">
                ...
                <Button variant="ghost" size="sm" onClick={() => setDel(c.code)}>
