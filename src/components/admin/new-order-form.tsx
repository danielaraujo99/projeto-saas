  ...
  async function submit() {
    ...
    const { error } = await supabase
      ...
      .insert({
        ...
        address: pickup ? null : { id: "manual", kind: "other", ...address, lat: 0, lng: 0 },
      })
      .select()
      .single();
    setBusy(false);
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_360px]">
      ...
      <aside className="space-y-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-3">
          <h4 className="mb-2 text-xs font-bold uppercase tracking-wide text-slate-500">Entrega</h4>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-3">
          <h4 className="mb-2 text-xs font-bold uppercase tracking-wide text-slate-500">Pagamento</h4>
        ...
        <Button className="h-11 w-full text-sm font-semibold" onClick={submit} disabled={busy}>
